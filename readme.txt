...
2) Create the database with any name on your local pc, I a using "airl" this dabase name in this code, if you will create with same db name then you don`t need to change the db name in code.
3) In this folder there is a sql file named "airl.sql", please import this file into the databse that you just created.
